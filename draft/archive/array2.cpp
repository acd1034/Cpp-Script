...
#define DEFINE_ITERATOR_COMPARE(ItrT)                                          \
  ...
  bool operator>(ItrT<Array> const& x, ItrT<Array> const& y) {                 \
    return y < x;                                                              \
  }                                                                            \
  template <typename Array>                                                    \
  bool operator<=(ItrT<Array> const& x, ItrT<Array> const& y) {                \
...
#define DEFINE_ITERATOR_CREMENT(ItrT, Op)                                      \
  ...
  template <typename Array>
  bool operator<(array_iterator<Array> const& x,
                 array_iterator<Array> const& y) {
    return x.i < y.i;
  }
  ...
  struct array_const_iterator {
    ...
    array_const_iterator(typename container_t::iterator const& itr)
      : a(itr.a), i(itr.i) {}
  ...
  template <typename Array>
  bool operator<(array_const_iterator<Array> const& x,
                 array_const_iterator<Array> const& y) {
    return x.i < y.i;
  }
