...
m2r operator+(const m2r& m1, const m2r& m2) {
  return make_pair(
    make_pair(m1.first.first + m2.first.first, m1.first.second + m2.first.second),
    make_pair(m1.second.first + m2.second.first, m1.second.second + m2.second.second));
}
m2r operator-(const m2r& m1, const m2r& m2) {
  return make_pair(
    make_pair(m1.first.first - m2.first.first, m1.first.second - m2.first.second),
...
m2r operator*(const m2r& m1, const m2r& m2) {
  return make_pair(
    make_pair(m1.first.first * m2.first.first + m1.first.second * m2.second.first,
              m1.first.first * m2.first.second + m1.first.second * m2.second.second),
    make_pair(m1.second.first * m2.first.first + m1.second.second * m2.second.first,
...
m2r mm(const r2& v1, const r2& v2) {
  return make_pair(make_pair(v1.first * v2.first, v1.first * v2.second),
...
int main() {
  ...
  hess hf = [](const r2& x) -> m2r {
    return make_pair(make_pair(1200 * pow(x.first, 2) - 400 * x.second + 2, -400 * x.first),
                     make_pair(-400 * x.first, 200));
  };
